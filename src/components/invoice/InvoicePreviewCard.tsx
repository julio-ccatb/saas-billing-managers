      ...
      <div className="p-8 space-y-8 text-gray-800 text-sm">
        ...
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-sm font-semibold text-blue-600 mt-1">#{invoice.invoiceNumber || "DRAFT"}</p>
          </div>
        ...
        <div className="grid grid-cols-2 gap-8 pt-4 border-t border-gray-100">
          <div>
            <p className="text-xs uppercase tracking-wider text-gray-400 font-semibold mb-2">From</p>
          ...
          <div>
            <p className="text-xs uppercase tracking-wider text-gray-400 font-semibold mb-2">Billed To</p>
        ...
        <div className="pt-4 border-t border-gray-100 flex justify-end">
          <div className="w-64 space-y-2 text-sm">
            ...
            <div className="flex justify-between pt-2 border-t-2 border-gray-200 font-bold text-gray-900 text-base">
              <span>Total Due</span>
              <span className="text-blue-600">{formatCurrency(totals.totalAmount, invoice.currency)}</span>
            </div>
          </div>
        </div>
